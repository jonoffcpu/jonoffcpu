...
package io.github.jonoffcpu.packaging;
...
class CorrelatorPublicApiTest {
    private static final String SHADED = "io.github.jonoffcpu.correlator.internal.shaded";

    @ParameterizedTest
    @ValueSource(
            strings = {"io.github.jonoffcpu.offline.OffCpuCorrelator", "io.github.jonoffcpu.offline.SignalJfrExporter"})
    ...
    void implementationClassesStayPackagePrivate() throws Exception {
        for (String name : List.of(
                "io.github.jonoffcpu.offline.OfflineCorrelator",
                "io.github.jonoffcpu.offline.CompatibilityJfrWriter")) {
