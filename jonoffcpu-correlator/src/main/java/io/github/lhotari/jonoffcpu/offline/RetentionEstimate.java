 ...
 * 1,121,418 {@code profiler.SignalSample} events (35 bytes each). A source column slot is 38 bytes,
 * a sample slot 38, and a cookie index entry 24 at the index's half load factor. Interned stacks
...
record RetentionEstimate(long sourceBytes, long jfrBytes, long observations, long samples, long retainedBytes) {
    ...
    private static final long SOURCE_SLOT_BYTES = 38;
