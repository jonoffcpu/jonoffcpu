...
use jonoffcpu_native::bpf_finish_fentry::JonoffcpuCookieSkelBuilder;
...
fn main() -> Result<()> {
    ...
    let _switch_in = skel
        ...
        .capture_switch_in
        .attach()
        .context("attach fentry transport at finish_task_switch BTF ID")?;
    ...
    let result = ProofResult {
        ...
        hook: "fentry/finish_task_switch (BTF ID resolved by kernel)".to_string(),
