...
Pass a tag such as `v0.4.0` after `download` to pick a specific release
...
```kotlin
dependencies {
    implementation("io.github.lhotari:jonoffcpu-agent:0.4.0")
    implementation("io.github.lhotari:jonoffcpu-correlator:0.4.0")
    implementation("io.github.lhotari:jonoffcpu-jfr-converter:0.4.0")
}
```
